...
const PAST_EVENTS: PastEvent[] = [
  { eventFormat: "triton1", name: "Salvador", year: 2026, slug: "salvador-2026", startList: "https://api.raceresult.com/371805/RQDKNSO0GU02BW4IF4X1G7AF12S073FW", results: "https://api.raceresult.com/362673/BC9WES9T0B422JUHYB1X7DX40NYQXE4T" },
      ...
      >
        <div className="max-w-2xl w-full text-center relative z-10 mt-8 sm:mt-12 flex flex-col items-center px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            {liveEvent &&
              <MainButton href={liveEvent?.athleteArea?.liveResultsUrl || liveEvent?.liveResultsUrl || "#"}>
                Go to Live Results
              </MainButton>
            }
          </div>
