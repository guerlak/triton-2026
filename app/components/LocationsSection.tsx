    ...
    return (
        <section id="locations" className="py-0 bg-black">
            ...
            <div className="bg-triton-red py-10 px-4 text-center">
                <h3 className="text-2xl md:text-3xl font-black text-white uppercase mb-2">{dict.locations_section.banner.title}</h3>
                <p className="text-white/80 max-w-3xl mx-auto">
                    {dict.locations_section.banner.description}
                </p>
            </div>
            <div className="text-center py-14 px-4">
                <h2 className="text-triton-red font-bold tracking-widest uppercase mb-2">{dict.locations_section.title}</h2>
                ...
                <div className='md:max-w-[1200px] grid md:grid-cols-2 grid-cols-1 justify-center mt-20 gap-10 mx-auto'>
                    ...
                    <div className='text-left p-4 md:p-0'>
                        <h1 className='text-2xl uppercase font-black mb-2'>{dict.locations_section.resort.title}</h1>
                        <h2>
                            {dict.locations_section.resort.description}
                        </h2>
                        <ul className="space-y-2 text-gray-300 mb-8 mt-4">
                            <li className="flex items-center"><span className="w-2 h-2 bg-triton-red rounded-full mr-3"></span>{dict.locations_section.resort.list_1}</li>
                            <li className="flex items-center"><span className="w-2 h-2 bg-triton-red rounded-full mr-3"></span>{dict.locations_section.resort.list_2}</li>
                            <li className="flex items-center"><span className="w-2 h-2 bg-triton-red rounded-full mr-3"></span>{dict.locations_section.resort.list_3}</li>
                        </ul>
                ...
                <div className="mx-auto md:max-w-[1200px] mt-10 bg-linear-to-r from-neutral-900 to-neutral-800 rounded-2xl p-8 md:p-8 border-l-4 border-triton-red shadow-2xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-center lg:text-left">
                        <div>
                            <h3 className="text-2xl font-black uppercase text-white mb-4"> {dict.locations_section.other_options.title}</h3>
