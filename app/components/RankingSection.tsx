...
export default async function RankingSection() {
  ...
  return (
    <section id="ranking" className="py-8 sm:py-14 bg-neutral-950 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-8 sm:mb-16">
          <h2 className="text-triton-red font-bold tracking-widest uppercase mb-1.5 sm:mb-2 text-xs sm:text-sm flex items-center justify-center gap-2">
            <Trophy className="w-4 h-4 sm:w-5 sm:h-5" /> Global Ranking
          </h2>
          <h3 className="text-2xl sm:text-3xl md:text-5xl font-black uppercase text-white mb-3 sm:mb-6">
            TOP 3 LEADER BOARD
          </h3>
          <p className="text-gray-400 max-w-4xl mx-auto text-xs sm:text-base md:text-lg mt-2 sm:mt-4">
