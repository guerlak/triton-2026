...
const RankingSection: React.FC = () => {
  ...
  const filteredAthletes = athletes.filter(
    (athlete) =>
      ...
      athlete.Contest.toLowerCase().includes(searchTerm.toLowerCase()),
  );
    ...
    <section id="ranking" className="py-24 bg-neutral-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="overflow-x-auto">
            {loading ? (
              ...
              <table className="w-full text-left border-collapse min-w-[1000px]">
                ...
                <tbody>
                  {womenAthletes.slice(0, 3).map((athlete, idx) => (
                    <tr
                      key={athlete.Bib}
              ...
              <table className="w-full text-left border-collapse min-w-[1000px]">
                <thead>
                  <tr className="bg-black/40 text-xs font-bold uppercase tracking-wider text-gray-500 border-b border-white/5">
                    ...
                    <th className="py-5 px-6">Distance</th>
                ...
                <tbody>
                  {menAthletes.slice(0, 3).map((athlete, idx) => (
                    <tr
                      key={athlete.Bib}
                      className="border-b border-white/5 hover:bg-white/5 transition-colors group"
                    >
        ...
        <div className="p-6 text-center mt-5">
          <button className="text-sm font-bold uppercase tracking-widest text-triton-red hover:text-white transition-colors">
