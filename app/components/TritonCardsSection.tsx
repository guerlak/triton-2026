...
const TritonExperienceCards: React.FC = () => {
  return (
    <section className="py-8 sm:py-12 md:py-20 bg-triton-dark overflow-hidden relative" id="formats">
      <div className="text-center mb-8 sm:mb-14 md:mb-16">
        <h2 className="text-triton-red font-bold tracking-widest uppercase mb-1.5 sm:mb-2 text-xs sm:text-sm md:text-lg">
        ...
        <p className="text-gray-400 max-w-4xl mx-auto text-xs sm:text-base md:text-lg mt-3 sm:mt-4 px-4 sm:px-8">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-6 sm:mb-10">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-triton-red font-black tracking-widest uppercase text-sm mb-4 hidden"
          >
          ...
          <motion.h3
            ...
            className="text-3xl sm:text-5xl md:text-7xl font-black uppercase text-white tracking-tighter leading-none"
          ></motion.h3>
        </div>

        <div className="flex overflow-x-auto snap-x snap-mandatory gap-4 sm:gap-6 pb-4 md:grid md:grid-cols-2 md:gap-8 
        ...
        [&::-webkit-scrollbar]:hidden">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.1 }}
            className="shrink-0 w-[88%] md:w-full snap-center group relative bg-neutral-900 rounded-3xl sm:rounded-[2.5rem] 
            p-6 sm:p-10 lg:p-16 border-3 border-white/5 hover:border-triton-red transition-all
          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-triton-red/10 border border-triton-red/20
               text-triton-red text-[11px] sm:text-xs font-black uppercase tracking-widest mb-6 sm:mb-8">
                <Clock size={14} />STANDARD TRIATHLON
              </div>

              <h4 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white uppercase mb-4 sm:mb-6 tracking-tighter">
                Triton <span className="text-triton-red">1</span>
              </h4>

              <p className="text-sm sm:text-base md:text-xl text-gray-400 mb-6 sm:mb-10 leading-relaxed max-w-md">
              ...
              <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-12">
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                    <Zap className="text-triton-red w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <p className="text-white font-bold uppercase tracking-wide text-xs sm:text-base">
                      Pure Performance
                    </p>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                    <CheckCircle className="text-triton-red w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <p className="text-white font-bold uppercase tracking-wide text-xs sm:text-base">
                      Competition Options
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                    <Blend className="text-triton-red w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <p className="text-white font-bold uppercase tracking-wide text-xs sm:text-base">
                      MIX & MATCH
              ...
              <div className="flex items-center gap-3 sm:gap-4 pt-6 sm:pt-8 border-t border-white/5">
                <div className="flex -space-x-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-neutral-800 border-2 border-neutral-900 flex items-center justify-center">
                  ...
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-neutral-800 border-2 border-neutral-900 flex items-center justify-center">
                    <PersonStanding size={13} className="text-gray-400" />
                  </div>
                </div>
          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-triton-red/10 border border-triton-red/20 text-triton-red text-[11px] sm:text-xs font-black uppercase tracking-widest mb-6 sm:mb-8">
              ...
              <div className="space-y-4 sm:space-y-6 mb-8 sm:mb-12">
                <div className="flex items-start gap-3 sm:gap-4">
                  <div className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-white/5 flex items-center justify-center shrink-0">
                    <Calendar className="text-triton-red w-4 h-4 sm:w-5 sm:h-5" />
                  </div>
                  <div>
                    <p className="text-white font-bold uppercase tracking-wide text-xs sm:text-base">
                      3 CONSECUTIVE RACE DAYS
                    </p>
                    <p className="text-gray-500 text-xs sm:text-sm">
              ...
              <div className="flex items-center gap-3 sm:gap-4 pt-6 sm:pt-8 border-t border-white/5 bottom-0">
                <div className="flex -space-x-2">
                  <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-neutral-800 border-2 border-neutral-900 flex items-center justify-center">
                    <Waves size={13} className="text-gray-400" />
                  </div>
