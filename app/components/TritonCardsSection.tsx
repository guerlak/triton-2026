  ...
  return (
    <section className="py-12 bg-triton-dark overflow-hidden relative" id="formats">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        lg:gap-12 md:pb-0 md:overflow-x-visible [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-triton-red/10 border border-triton-red/20 text-triton-red text-xs font-black uppercase tracking-widest">
                <Calendar size={14} />3 Days of Competition
              </div>

              <h4 className="text-5xl lg:text-6xl font-black text-white uppercase mb-5 mt-7 tracking-tighter">
