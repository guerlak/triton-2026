...
const CountdownSection: React.FC = () => {
  ...
  const targetDate1 = new Date("2026-04-12T08:00:00").getTime();
  const targetDate2 = new Date("2026-04-12T08:00:00").getTime();
  const targetDate3 = new Date("2026-04-12T08:00:00").getTime();
