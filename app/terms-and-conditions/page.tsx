...
export default function TermsAndConditions() {
    ...
    return (
        <div className="bg-black min-h-screen text-white font-sans selection:bg-triton-red selection:text-white pb-20">
            <Navbar />
            ...
            <main className="pt-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
                ...
                >
                    <h1 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-4 bg-gradient-to-b from-white to-gray-500 bg-clip-text text-transparent">
                        ...
                        <span className="text-triton-red italic text-2xl md:text-4xl text-pretty">WAIVER AND RELEASE OF LIABILITY, ASSUMPTION OF RISK AND INDEMNITY</span>
                    </h1>
